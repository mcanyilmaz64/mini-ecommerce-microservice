...
<img width="332" height="289" alt="image" src="https://github.com/user-attachments/assets/16bf0bc7-fe0e-4f3b-a763-66086a165109" />
...
- Angular (Kullanıcı Arayüzü)

- .NET 8 Web API

- YARP API Gateway

- MSSQL — Products Service

- PostgreSQL — Shopping Carts Service

- MongoDB — Orders Service

- Docker & Docker Compose (Dağıtım)
